...
HD_PWD='C:/Users/hp/Downloads/FPGA-Based Pesticide Detection in Soil using SVM Classification and Mid-Infrared Spectroscopy/Verilog Code/FPGA-Based Pesticide Detection System.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log top_nexys4.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source top_nexys4.tcl
